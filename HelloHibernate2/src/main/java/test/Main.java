...
public class Main {
	...
	private static final String DB_CONNECTION = "jdbc:mysql://localhost:3307/soa";
...
//				System.out.println("Customer.dat is created at: " + new File("Customer.dat").getAbsolutePath());
				...
				WebResource webResource = client.resource("http://localhost:8082/HelloHibernate/rest/services/customers/A");
